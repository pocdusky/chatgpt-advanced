...
const Footer = () => (
    <div className="wcg-flex wcg-flex-col wcg-items-center wcg-p-4" >
        ...
        <div className="wcg-flex wcg-flex-row wcg-items-center wcg-gap-4">
            <a className="wcg-p-4" href="https://www.buymeacoffee.com/pocdusky?utm_source=pocGPT&utm_medium=options_page" target="_blank" rel="noopener noreferrer">
                <img src="https://img.buymeacoffee.com/button-api/?text=Support this project&slug=pocdusky&button_colour=FFDD00&font_colour=000000&font_family=Poppins&outline_colour=000000&coffee_colour=ffffff" alt="Buy Me A Coffee" />
            </a>
            <a className="wcg-p-4" href="https://chrome.google.com/webstore/detail/pocGPT-chatgpt-with-i/lpfemeioodjbpieminkklglpmhlngfcn/reviews" target="_blank" rel="noopener noreferrer">
